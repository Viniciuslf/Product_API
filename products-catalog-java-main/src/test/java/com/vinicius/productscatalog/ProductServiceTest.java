...
import com.vinicius.productscatalog.ProductRepository;
import com.vinicius.productscatalog.ProductService;
...
class ProductServiceTest {
    ...
    void testUpdate_ValidFields() {
        ...
        assertEquals(1, updatedProduct.getStock(), "product quantity should remain the same");
